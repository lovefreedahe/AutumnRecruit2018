...
- [十、java内存模型](#十java内存模型)
    ...
    - [内存模型三大特性](#内存模型三大特性)
        ...
        - [3. 有序性](#3-有序性)
    - [先行发生原则](#先行发生原则)
        - [1.单一线程原则(Single Thread Rule)](#1单一线程原则single-thread-rule)
        - [2.管程锁定规则(Monitor Lock Rule)](#2管程锁定规则monitor-lock-rule)
        - [3.volatile 变量规则(Vilatile Variable Rule)](#3volatile-变量规则vilatile-variable-rule)
        - [4.线程启动原则(Thread Start Rule)](#4线程启动原则thread-start-rule)
        - [5.线程加入原则(Thread Join Rule)](#5线程加入原则thread-join-rule)
        - [6.线程中断规则(Thread Interruption Rule)](#6线程中断规则thread-interruption-rule)
        - [7.对象终结原则(Finallizer Rule)](#7对象终结原则finallizer-rule)
        - [8.传递性(Transitivity)](#8传递性transitivity)
- [十一、线程安全](#十一线程安全)
    - [线程安全定义](#线程安全定义)
    - [线程安全分类](#线程安全分类)
        - [1.不可变](#1不可变)
...
<!-- /TOC -->
# 一、线程状态转换
<div align="center"><img src="../../resources/images/java/concurrency/concurrency_condition.png" ></div>
...
下图应该从下往上看才正确。
<div align="center"><img src="../../resources/images/java/concurrency/CyclicBarrier.png" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/Semaphore.png" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/ForkJoin.jpg" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/CPU.png" ></div>

所有的变量都存储在主内存中，每个线程还有自己的工作内存，工作内存存储在高速缓存或者寄存器中，保存了该线程使用的变量的主内存副本拷贝。

线程只能直接操作工作内存中的变量，不同线程之间的变量值传递需要通过主内存来完成。
<div align="center"><img src="../../resources/images/java/concurrency/thread_memory.png" ></div>

## 内存间交互操作
Java 内存模型定义了 8 个操作来完成主内存和工作内存的交互操作。
<div align="center"><img src="../../resources/images/java/concurrency/memory.png" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/java_memory.png" ></div>
AtomicInteger 能保证多个线程修改的原子性。

<div align="center"><img src="../../resources/images/java/concurrency/Atomic.png" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/single-thread-rule.png" ></div>

### 2.管程锁定规则(Monitor Lock Rule)

一个 unlock 操作先行发生于后面对同一个锁的 lock 操作。
<div align="center"><img src="../../resources/images/java/concurrency/monitor-lock-rule.png" ></div>

### 3.volatile 变量规则(Vilatile Variable Rule)
对一个 volatile 变量的写操作先行发生于后面对这个变量的读操作。

<div align="center"><img src="../../resources/images/java/concurrency/volatile-variable-rule.png" ></div>

### 4.线程启动原则(Thread Start Rule)
Thread 对象的 start() 方法调用先行发生于此线程的每一个动作。
<div align="center"><img src="../../resources/images/java/concurrency/thread-start-rule.png" ></div>

### 5.线程加入原则(Thread Join Rule)
join() 方法返回先行发生于 Thread 对象的结束。
<div align="center"><img src="../../resources/images/java/concurrency/thread-join-rule.png" ></div>

### 6.线程中断规则(Thread Interruption Rule)
对线程 interrupt() 方法的调用先行发生于被中断线程的代码检测到中断事件的发生，可以通过 Thread.interrupted() 方法检测到是否有中断发生。

### 7.对象终结原则(Finallizer Rule)
...
```
它所对应的底层结构图为：
<div align="center"><img src="../../resources/images/java/concurrency/thread-local.png" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/light-lock.png" ></div>

下图左侧是一个线程的虚拟机栈，其中有一部分称为 Lock Record 的区域，这是在轻量级锁运行过程创建的，用于存放锁对象的 Mark Word。而右侧就是一个锁对象，包含了 Mark Word 和其它信息。

<div align="center"><img src="../../resources/images/java/concurrency/light-lock2.png" ></div>
...
<div align="center"><img src="../../resources/images/java/concurrency/light-lock3.png" ></div>
